...
package, targeting Bioconductor.
...
STRprofilerR is score-for-score identical to `strprofiler` — its test
suite includes the Python suite’s assertions verbatim — but diverges
deliberately in several places, mostly to fix latent bugs. See
[NEWS.md](https://j-andrews7.github.io/STRprofilerR/NEWS.md) for the
full list.

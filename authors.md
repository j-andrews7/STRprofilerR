...
of short tandem repeat profiles for biomedical model authentication.”
*Bioinformatics*.
[doi:10.1093/bioinformatics/btae713](https://doi.org/10.1093/bioinformatics/btae713).

    @Article{,
      title = {STRprofiler: efficient comparisons of short tandem repeat profiles for biomedical model authentication},
      author = {Jared M Andrews and Michael W Lloyd and Steven B Neuhauser and Margaret Bundy and Emily L Jocoy and Susan D Airhart and Carol J Bult and Yvonne A Evrard and Jeffrey H Chuang and Suzanne Baker},
...
[doi:10.1002/ijc.32639](https://doi.org/10.1002/ijc.32639).
    ...
    @Article{,
      ...
      author = {Thomas Robin and Amanda Capes-Davis and Amos Bairoch},
